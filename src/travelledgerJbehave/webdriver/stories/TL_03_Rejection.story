...
Then Filter for "ER1234184" booking reference
Then Check that transaction status dropdown has proper elements for "ER1234184"
Then Click on the "ER1234184" transaction status which has blank status and select REJECTED status
