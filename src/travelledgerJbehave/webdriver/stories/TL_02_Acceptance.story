...
Then Filter for "ER1234147" booking reference
Then Check that transaction status dropdown has proper elements for "ER1234147"
Then Click on the "ER1234147" transaction status which has blank status and select ACCEPTED status